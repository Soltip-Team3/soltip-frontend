...
const PAGE_BG: React.CSSProperties = {
  background:
    "radial-gradient(ellipse 80% 50% at 10% 0%, rgba(124,58,237,0.12) 0%, transparent 70%)," +
    "radial-gradient(ellipse 60% 40% at 90% 100%, rgba(139,92,246,0.08) 0%, transparent 60%)," +
    "#09090b",
};
      ...
      <main className="mx-auto w-full max-w-5xl px-6 py-10 space-y-8">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <section>
            ...
            <div className="rounded-2xl border border-zinc-800/80 overflow-hidden" style={{ background: "rgba(24,24,27,0.7)", backdropFilter: "blur(12px)" }}>
              {statsLoading ? (
...
function StatCard({ icon, label, value, sub, accent }: {
  ...
  const bg = { green: "rgba(34,197,94,0.05)", purple: "rgba(124,58,237,0.07)", violet: "rgba(139,92,246,0.06)" };
